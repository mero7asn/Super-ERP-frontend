          ...
          <div className="mini-sidebar-group">
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                ...
                <span className="mini-sidebar-arrow">{crmOpen ? '▾' : '▸'}</span>
              </div>
            </div>
          ...
          <div className="mini-sidebar-group">
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                ...
                <span className="mini-sidebar-arrow">{inventoryOpen ? '▾' : '▸'}</span>
              </div>
            </div>
          ...
          <div className="mini-sidebar-group">
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                ...
                <span className="mini-sidebar-arrow">{supplyChainOpen ? '▾' : '▸'}</span>
              </div>
            </div>
          ...
          <div className="mini-sidebar-group">
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                ...
                <span className="mini-sidebar-arrow">{hrmOpen ? '▾' : '▸'}</span>
              </div>
            </div>
        ...
        <div className="mini-sidebar-group">
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              <span className="mini-sidebar-arrow">{workspaceOpen ? '▾' : '▸'}</span>
            </div>
          </div>
