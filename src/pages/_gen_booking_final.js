...
c += "const canAccess=['Sales Agent','Sales Manager','Customer Support Agent','Customer Support Manager','CRM Developer','CRM Consultant','System Architect','Core 360 Administrator'].includes(currentRole);";
c += "const canRefund=['Finance Manager','Finance Analyst','Core 360 Administrator','CRM Developer','CRM Consultant','System Architect'].includes(currentRole);";
c += "const canCancel=['Sales Manager','Customer Support Manager','Core 360 Administrator','CRM Developer','CRM Consultant','System Architect'].includes(currentRole);";
c += "const canDelete=['Core 360 Administrator','CRM Developer','System Architect'].includes(currentRole);";
// handleLookup
